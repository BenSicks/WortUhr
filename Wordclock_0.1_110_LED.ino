...
#define PIN            5
#define NUMPIXELS      110    // 110 LEDs beginnend bei 0
...
void setup() {
  ...
  //wifiManager.resetSettings();
                                        ...
                                        // wifiManager.autoConnect("FRITZ!Ben7530 VZ", "54032614993526759056");
  wifiManager.autoConnect("WordclockAP", "passwort123");
